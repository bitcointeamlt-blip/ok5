  ...
  build: {
    ...
    rollupOptions: {
      output: {
        ...
        // Force new hash on each build by including version in chunk names
        entryFileNames: `assets/index-[hash]-v1.0.13.js`,
        chunkFileNames: `assets/[name]-[hash]-v1.0.13.js`,
        assetFileNames: `assets/[name]-[hash]-v1.0.13.[ext]`
      }
    }
  }
