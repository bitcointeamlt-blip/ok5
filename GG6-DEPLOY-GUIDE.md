# GG6 Deployment Guide

## Overview
GG6.zip yra naujausia žaidimo versija su:
...
### 🎨 UI Improvements
- **Pašalinta HP/Armor info virš oponento** - dabar rodoma tik kairėje panelėje
- **Fiksuotos spalvos** - mėlynas jūsų žaidėjas, raudonas oponentas
- Aiškesnė vizualinė atskirtis tarp žaidėjų
...
- Patikrinkite, ar opponent teisingai inicializuojamas
- Patikrinkite naršyklės konsolę (F12) dėl klaidų
- Patikrinkite, ar `opponentId` yra teisingai nustatytas

### Opponent pozicija neatsinaujina
...
- Patikrinkite, ar naudojate GG6.zip (ne senesnę versiją)
- Patikrinkite naršyklės konsolę (F12) dėl klaidų
...
- `.env` failas yra įtrauktas į GG6.zip, bet Netlify naudoja environment variables
